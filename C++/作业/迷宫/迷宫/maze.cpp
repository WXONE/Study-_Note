...
/*全局变量*/
DWORD* p_Screen;																	   //显存指针
DWORD buff_Screen[10000000];					 //显示缓存
int isShowFPS = 1;																			//是否显示帧数
int isShowMazePath = 0;																	//显示迷宫路径
int Maze[M][N];																				//迷宫数组 0 普通通路 1墙 2路径点 3起点 4终点
...
void FindPath(int x, int y)									//深度优先搜索迷宫路径
{
	Maze[y][x] = 2;
